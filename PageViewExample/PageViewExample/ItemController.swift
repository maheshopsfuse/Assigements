...
class ItemController: UIPageViewController {
    ...
    fileprivate func decoratePageControl() {
        let pc = UIPageControl.appearance(whenContainedInInstancesOf: [ItemController.self])
    ...
    fileprivate func createCarouselItemControler(with titleText: String?, with color: UIColor?) -> UIViewController {
        ...
        c.view = ItemContent(titleText: titleText, background: color)
...
extension ItemController: UIPageViewControllerDataSource {
